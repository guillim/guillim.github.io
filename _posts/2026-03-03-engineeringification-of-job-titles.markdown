---
layout: blog
title: "The engineeringification of job titles"
...
1. **Execution moves closer to the role**  
   Designers can ship components, sales teams can automate workflows, support teams can instrument product feedback.
2. **The handoff model breaks**  
   Waiting for a specialist team for every task is too slow.
3. **Identity follows capability**  
...
1. Pick one high-leverage tool in your role and master it deeply.
...
- [The engineeringification of everything (Ian Vanagas)](https://newsletter.posthog.com/p/the-engineeringification-of-everything)
